...
class AuthServiceTest {
    ...
    void register_shouldReturnAuthResponse_whenEmailDoesNotExist() {
        ...
        when(walletRepository.save(any(com.pm.userservice.model.Wallet.class)))
        ...
        verify(walletRepository).save(any(com.pm.userservice.model.Wallet.class));
    ...
    void register_shouldThrowEmailAlreadyExistsException_whenEmailExists() {
        ...
        verify(walletRepository, never()).save(any(com.pm.userservice.model.Wallet.class));
    }
